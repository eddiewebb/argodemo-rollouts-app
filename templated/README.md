...
The source of the kargo workflow is a [helm chart](https://github.com/akuity/sedemo-platform/tree/main/templated_teams/kargo-helm) in the platform team repo. 

The source of the k8s manifests is also [in the platform repo](https://github.com/akuity/sedemo-platform/tree/main/templated_teams/apps-helm)

Both are triggered by [Application Sets](https://github.com/akuity/sedemo-platform/tree/main/templated_teams) using the Git Generator.
